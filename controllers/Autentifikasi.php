...
class Autentifikasi extends CI_Controller {
    ...
    function cekLogin(){
            ...
            $cek = $this->AuthModel->cekPetani($username);
            //var_dump($cek);die;
                if(password_verify($password, $cek['ptnPassword'])){
                    ...
                    $cek = $this->AuthModel->cekMitra($username);
                //var_dump($cek);die;
                if(password_verify($password, $cek['mtrPassword'])){
                    $data = [
                    ...
                    $cek = $this->AuthModel->cekInvestor($username);
                //var_dump($cek);die;
                if(password_verify($password, $cek['invPassword'])){
                    $data = [
                        'username' => $cek['invUsername'],
                        'role' => $cek['role']
                    ];
                    $this->session->set_userdata($data);
                    if($cek['role'] == 'investor'){
                        redirect('Investor');
                    }
                }
                }
